 ...
 */
public class FipaAction extends FipaObject {

    public FipaAction(String content, String language, String replyWith, String inReplyTo, String ontology, String protocol, InetSocketAddress sender, InetSocketAddress receiver) {
